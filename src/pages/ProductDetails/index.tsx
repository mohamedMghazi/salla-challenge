    ...
    return (
        <div className="p-2 sm:p-4 bg-white rounded-lg shadow-4xl">
            <div className="grid grid-cols-1 sm:grid-cols-3 sm:gap-4">
                <img src="/images/products/01.png" className="w-full aspect-4/3 object-cover rounded-lg mb-8 sm:mb-0"
                     alt="product img"/>
                <div className="flex flex-col gap-4 col-span-2">
                    ...
                    <div className="flex items-center justify-center gap-4">
                        ...
                        <button type="button"
                                className="w-full h-[42px] bg-primary text-white flex-1 p-2 text-md rounded-md">إضافة
                            للسلة
                        </button>
                    </div>
                </div>
